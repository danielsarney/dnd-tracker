    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, help_text='Encounter description', null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('campaign', models.ForeignKey(help_text='Associated campaign', on_delete=django.db.models.deletion.CASCADE, related_name='encounters', to='campaigns.campaign')),
                ('monsters', models.ManyToManyField(help_text='Monsters in this encounter', related_name='encounters', to='monsters.monster')),
                ('players', models.ManyToManyField(help_text='Players participating in this encounter', related_name='encounters', to='players.player')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ended_at', models.DateTimeField(blank=True, help_text='When combat ended', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('participant_type', models.CharField(choices=[('player', 'Player'), ('monster', 'Monster')], help_text='Whether this is a player or monster', max_length=10)),
