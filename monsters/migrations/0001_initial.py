    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hp', models.CharField(help_text='Hit Points (e.g., 333 (29d10 + 174))', max_length=100)),
                ('speed', models.CharField(help_text='Speed (e.g., 40 ft, Swim 10ft)', max_length=200)),
                ('strength', models.CharField(help_text='Strength (e.g., 24 +7)', max_length=50)),
                ...
                ('dexterity', models.CharField(help_text='Dexterity (e.g., 19 +4)', max_length=50)),
                ...
                ('constitution', models.CharField(help_text='Constitution', max_length=50)),
                ...
                ('intelligence', models.CharField(help_text='Intelligence', max_length=50)),
                ...
                ('senses', models.TextField(blank=True, help_text='Senses (e.g., darkvision 60ft)', null=True)),
                ('languages', models.TextField(blank=True, help_text='Languages known', null=True)),
                ...
                ('actions', models.TextField(blank=True, help_text='Actions', null=True)),
